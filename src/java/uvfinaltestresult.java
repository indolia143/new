 ...
 * @author kkyd
 */
public class uvfinaltestresult extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
           ...
           int c1=0;
            ...
            String q="select *from uvvalidtest1;";
           ...
           String result1=rs.getString(1);
            ...
            String q1="select *from uvinvalid1;";
...
out.println("<font color='lightgreen' size='10'>total no of wrong test case result:</font>"+"<font size='10'>"+c1+"</font><br>");
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(uvfinaltestresult.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
