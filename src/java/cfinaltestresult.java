 ...
 * @author kkyd
 */
public class cfinaltestresult extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
           ...
           int c1=0;
            ...
            String q="select *from clvalidresult1;";
...
out.print("here");
           ...
           String result1=rs.getString(1);
            ...
            String q1="select *from clinvalidresult2;";
...
out.println("<font color='lightgreen' size='10'>total no of wrong test case result:</font>"+"<font size='10'>"+c1+"</font><br>");
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(cfinaltestresult.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
