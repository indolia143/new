 ...
 * @author kkyd
 */
public class testcandidatelogin extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        while(rs1.next()){
           ...
           if((cid2.equals(cid1))&& (pass2.equals(pass1)))
           {
           String q1="insert into cltestcase1 (cid,pass,result) values ('"+cid1+"','"+pass1+"','"+"yes"+"');";
           int r=dao.DBService.updateData(q1);
           if(r==1)
           {
           String q3="insert into clvalidresult1 values ();";
           int r1=dao.DBService.updateData(q3);
           }
           }
 else
           {
 String q2="insert into cltestcase1 (cid,pass,result) values ('"+cid1+"','"+pass1+"','"+"no"+"');";
 int w=dao.DBService.updateData(q2);
 if(w==1)
 {
 String q4="insert into clinvalidresult2 values ();";
 int r2=dao.DBService.updateData(q4);
            ...
            out.print("<a href='candidatelogintestresult'>click");out.print("</a>");
            out.println("</body>");
            out.println("</html>");
        } finally { 
            out.close();
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(testcandidatelogin.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
