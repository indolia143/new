 ...
 * @author kkyd
 */
public class vltefinaltestresult extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
           ...
           int c1=0;
            ...
            String q="select *from vtdevalid1;";
           ...
           String result1=rs.getString(1);
            ...
            String q1="select *from vtdeinvalid1;";
...
out.println("<font color='lightgreen' size='10'>total no of wrong test case result:</font>"+"<font size='10'>"+c1+"</font><br>");
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(vltefinaltestresult.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
