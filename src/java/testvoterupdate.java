 ...
 * @author kkyd
 */
public class testvoterupdate extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
           ...
           if((vid2.equals(vid1))&& (pass2.equals(pass1))&&(pass2.equals(cpass1)))
           {
           String q1="insert into uvtestcase1 (vid,pass,cpass,result) values ('"+vid1+"','"+pass1+"','"+cpass1+"','"+"yes"+"');";
           int r=dao.DBService.updateData(q1);
           if(r==1)
           {
           String q3="insert into uvvalidtest1 values ();";
           int r1=dao.DBService.updateData(q3);
           }
           }
 else
           {
 String q2="insert into  uvtestcase1  (vid,pass,cpass,result) values ('"+vid1+"','"+pass1+"',"+cpass1+",'"+"no"+"');";
 int w=dao.DBService.updateData(q2);
 if(w==1)
 {
 String q4="insert into uvinvalid1 values ();";
 int r2=dao.DBService.updateData(q4);
            ...
            out.print("<a href='voterupdatetestresult'>click");out.print("</a>");
            out.println("</body>");
            out.println("</html>");
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(testvoterupdate.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
